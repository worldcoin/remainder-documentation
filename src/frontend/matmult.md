...
Here's the complete code for this example, which can also be found in our repository at[`frontend/examples/matmult.rs`](https://github.com/worldcoin/Remainder_CE/blob/44a2526d0b54774eec44b7ea8739c5fa3dd66a9b/frontend/examples/matmult.rs):
