...
GKR is an [interactive protocol](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/12/2008-DelegatingComputation.pdf) which was first introduced by Goldwasser, Kalai, and Rothblum [2008]. It proves the statement that $C(y) = 0$, where $C$ is a [layered arithmetic circuit](#statement-encoding), and $y$ is the input to the circuit. 
...
### Claim reduction using Sumcheck and Multilinear Extensions
